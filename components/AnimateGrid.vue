<template>
  <div :class="cn('relative', props.class)">
    <div
      :class="
        cn(
          'relative grid p-10 max-w-full items-center justify-center',
          props.cards.length < 4 ? `grid-cols-${props.cards.length}` : 'grid-cols-2',
        )
      "
      :style="{
...
.card {
  box-shadow:
    2px 2px 5px rgba(91, 197, 242, 0.5),
    3px 3px 10px rgba(91, 197, 242, 0.5),
...
.card-raised-small {
  border: 1px solid rgba(245, 156, 0, 0.3);
